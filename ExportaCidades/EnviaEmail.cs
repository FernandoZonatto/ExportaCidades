...
namespace ExportaCidades.EnviaEmail
{
    public class EnviaEmail
    {
        public static string EnviaMensagem(string Destinatario, string Remetente,
                                string Assunto, string enviaMensagem, ArrayList anexos)
        {
            try
            {
                ...
                NetworkCredential cred = new NetworkCredential("fernandozonatto98@gmail.com", "Zonatto157");
